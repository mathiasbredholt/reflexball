...
void lvl_create_lvl1(GameData *gameData, PlayerData *playerData) {
	...
	gameData->blockData[2] [0][0] = 0xFF;
	gameData->blockData[2] [0][1] = 0xFF;
	gameData->blockData[2] [1][0] = 0xFF;
	gameData->blockData[2] [1][1] = 0xFF;
	gameData->blockData[2] [2][0] = 0xFF;
	gameData->blockData[2] [2][1] = 0xFF;
	gameData->blockData[2] [3][0] = 0xFF;
	gameData->blockData[2] [3][1] = 0xFF;
